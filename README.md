...
- `teoria/`: Resúmenes teóricos y notas sobre Grafos Probabilísticos, Do-calculus y Decisiones.
- `entregas/`: Trabajos prácticos obligatorios, cuestionarios y parciales evaluados.
- `laboratorio/`: Códigos de prueba en Python y simulaciones.

## 🚀 Entregas Principales
- [x] **Unidad 0:** [Cuestionario Inicial](entregas/0-previa/cuestionario_0.md)
